...
/*
Intuition (Kadane's Algorithm) (Sliding Window)
...
public class Solution {
    public int maxSubArray(int[] nums) {
        ...
        for (int i = 1; i < nums.length; i++) {
            // Choose the larger value between the current element and the currentSum + nums[i]
            // This step determines whether to start a new subarray or continue the existing one.
